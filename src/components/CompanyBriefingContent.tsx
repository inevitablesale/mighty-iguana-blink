...
interface CompanyBriefingContentProps {
  companyName: string;
}

export function CompanyBriefingContent({ companyName }: CompanyBriefingContentProps) {
  ...
  if (!briefing) {
    return <div className="py-4 text-center"><p className="text-muted-foreground">Could not generate briefing.</p></div>;
  }
